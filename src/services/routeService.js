...
export const fetchRouteData = async (routeId) => {
  ...
  export const optimizeRouteData = async(routeId) => {
      try {
  ...
  export const manualRouteData = async(routeId) => {
      try {
  ...
  export const getComparisonMap = async(routeId) => {
      try {
  ...
  export const getComparisonData = async (routeId) => {
